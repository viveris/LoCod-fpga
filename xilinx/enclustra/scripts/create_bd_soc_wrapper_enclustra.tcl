...
set bd_name bd_soc_wrapper_enclustra
...
create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_HPC0_FPD
set_property -dict [ list \
...
] [get_bd_intf_ports S_AXI_HPC0_FPD]
...
connect_bd_intf_net [get_bd_intf_ports S_AXI_HPC0_FPD] [get_bd_intf_pins zynq_ultra_ps_e/S_AXI_HPC0_FPD]
connect_bd_intf_net [get_bd_intf_ports M_AXI_HPM0_FPD] [get_bd_intf_pins zynq_ultra_ps_e/M_AXI_HPM0_FPD]


# Create port connections
connect_bd_net [get_bd_ports peripheral_aresetn] [get_bd_pins system_reset/peripheral_aresetn]
connect_bd_net [get_bd_ports pl_clk0] [get_bd_pins system_reset/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e/pl_clk0] [get_bd_pins zynq_ultra_ps_e/saxihpc0_fpd_aclk]
connect_bd_net [get_bd_pins system_reset/ext_reset_in] [get_bd_pins zynq_ultra_ps_e/pl_resetn0]


# Create address segments
assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs M_AXI_HPM0_FPD/Reg] -force
assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces S_AXI_HPC0_FPD] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_DDR_LOW] -force
assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces S_AXI_HPC0_FPD] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_LPS_OCM] -force
